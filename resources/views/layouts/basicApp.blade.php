    ...
    <div class="app">
        <div style="position: relative;height: 100%;width: 100%;border-radius: 25px;overflow: hidden;box-shadow: 0px 4px 25px rgba(0,0,0,0.35);">
            ...
            <div class="d-flex flex-column justify-content-center align-items-center appCont">
                ...
                <div role="dialog" tabindex="-1" class="modal fade" style="pointer-events:none;background:rgba(0, 0, 0, 0.5);">
                    <div style="pointer-events:inherit!important;" class="modal-dialog modal-xl modal-dialog-centered" role="document">
                        <div class="modal-content" style="pointer-events:inherit!important;">
                            <div class="modal-header" style="pointer-events:inherit!important;">
                                <h4 style="pointer-events:inherit!important;" class="modal-title">Checkout</h4><button style="pointer-events:inherit!important;outline: none!important;border: none!important;box-shadow: none!important;" type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button></div>
                            <div style="pointer-events:inherit!important;" class="modal-body">
                            ...
                            <div style="pointer-events:inherit!important;" class="modal-footer"><button class="btn closeBtn" style="pointer-events:inherit!important;outline: none!important;border: none!important;box-shadow: none!important;" type="button" data-dismiss="modal">Close</button><button class="btn checkout" type="button">Proceed To Paypal Checkout</button></div>
                        </div>
                    </div>
                </div>
                @yield('content')
